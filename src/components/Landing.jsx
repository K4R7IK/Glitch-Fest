  ...
  return (
    <div className="relative h-screen">
      ...
      <div className="absolute inset-0 flex items-center justify-center z-10 flex-col gap-3">
        ...
        <div className="bg-primary1 p-3 font-space-grotesk text-base rounded-full bg-opacity-30 backdrop-blur-lg text-white font-bold lg:text-xl lg:p-4 xl:text-2xl xl:p-5 disabled:pointer-events-none">
