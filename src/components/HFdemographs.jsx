...
function HFdemographs() {
  return (
    <div className="flex flex-wrap justify-center text-white py-5 lg:justify-around bg-black">
      <div className="flex justify-center items-center">
        <img src={Registration} alt="Registration" className="h-20" />
        <div className="ml-2 md:ml-0">
          <p className="font-bold text-lg md:text-xl lg:text-2xl">1500+</p>
      ...
      <div className="flex justify-center items-center">
        ...
        <div className="ml-2 md:ml-0">
          <p className="font-bold text-lg md:text-xl lg:text-2xl">50+</p>
      ...
      <div className="flex justify-center items-center">
        ...
        <div className="ml-2 md:ml-0">
          <p className="font-bold text-lg md:text-xl lg:text-2xl">15+</p>
