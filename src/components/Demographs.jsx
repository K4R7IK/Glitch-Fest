...
function Demographs() {
  return (
    <div className="bg-black h-64 p-40 flex justify-around items-center text-nbg" id="Demographs">
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="font-bold text-4xl mt-2">8000</p>
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="font-bold text-4xl mt-2">20000</p>
